...
export const tutorialCards = [
  { id: 1, number: 1, img: howItWorks1, text: "Для начала, укажите род проблемы. Это поможет определить контекст" },
  {
    id: 2,
    number: 2,
    img: howItWorks2,
  ...
  },
  {
    ...
    number: 5,
    img: howItWorks5,
    text: "Инициатива создана! Все инициативы сохраняются и доступны в личном кабинете.",
  },
  { id: 6, number: 6, img: howItWorks6, text: "Инициативой можно поделиться через соцсети или почту." },
];
...
export const problemTags = [
  { id: 1, tag: "Коммунальная" },
  { id: 2, tag: "Экономическая" },
  { id: 3, tag: "Социальная" },
  { id: 4, tag: "Трудовая" },
  { id: 5, tag: "Политическая" },
];

export const typeProblems = {
  Коммунальная: [
    { id: 1, tag: "Электричество" },
    { id: 2, tag: "Водопровод" },
    { id: 3, tag: "Соседи" },
    { id: 4, tag: "Платежи" },
    { id: 5, tag: "Другое" },
  ...
  Экономическая: [
    { id: 1, tag: "Проблемы бизнеса" },
    { id: 2, tag: "Платежи" },
    { id: 3, tag: "Налогообложение" },
    { id: 4, tag: "Другое" },
  ],
  Социальная: [
    { id: 1, tag: "Благоустройство" },
    { id: 2, tag: "Дискриминация" },
    { id: 3, tag: "Пособия" },
    { id: 4, tag: "Преступность" },
    { id: 5, tag: "Другое" },
  ],
  Трудовая: [
    { id: 1, tag: "Нарушение ТК" },
    { id: 2, tag: "Выплаты" },
    { id: 3, tag: "Безработица" },
    { id: 4, tag: "Другое" },
  ],
  Политическая: [
    { id: 1, tag: "Нарушение прав" },
    { id: 2, tag: "Коррупция" },
    { id: 3, tag: "Некомпетентность" },
    { id: 4, tag: "Другое" },
  ],
};
